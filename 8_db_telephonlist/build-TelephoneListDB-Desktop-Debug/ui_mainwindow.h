...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tableView->setGeometry(QRect(30, 20, 741, 411));
        widget = new QWidget(centralwidget);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(40, 450, 731, 27));
        ...
        horizontalLayout->addWidget(b_del);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        b_del->setText(QCoreApplication::translate("MainWindow", "Del", nullptr));
    } // retranslateUi
